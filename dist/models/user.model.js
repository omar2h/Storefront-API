...
var UserModel = /** @class */ (function () {
    ...
    UserModel.prototype.authenticate = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var result, savedPassword, isPasswordValid, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, connect_1["default"].query('SELECT password FROM users WHERE email=$1', [
                            email,
                        ])];
                    case 1:
                        result = _a.sent();
                        if (!result.rows[0])
                            throw new errors_1["default"].NotFoundError("Email: ".concat(email, " doesn't exist"));
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, connect_1["default"].query('SELECT * FROM users WHERE email=$1', [email])];
                    case 3:
                        user = _a.sent();
                        return [2 /*return*/, user.rows[0]];
                    case 4: throw new errors_1["default"].BadRequestError('Invalid password');
                }
            });
        });
    };
