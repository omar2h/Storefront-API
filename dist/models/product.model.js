        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, connect_1["default"].query('SELECT * FROM products')];
                    case 1:
                        result = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        if (!newProduct.product_uid) return [3 /*break*/, 2];
                        return [4 /*yield*/, connect_1["default"].query('INSERT INTO products (product_uid, name, price, category) VALUES ($1, $2, $3, $4) RETURNING *', [
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, connect_1["default"].query('SELECT * FROM products WHERE product_uid=($1)', [id])];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.rows[0]];
                    case 2:
