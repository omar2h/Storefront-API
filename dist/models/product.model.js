...
var ProductModel = /** @class */ (function () {
    ...
    ProductModel.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, connect_1["default"].query('SELECT * FROM products')];
                    case 1:
                        result = _a.sent();
    ...
    ProductModel.prototype.create = function (newProduct) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, connect_1["default"].query('INSERT INTO products (name, price, category) VALUES ($1, $2, $3) RETURNING *', [newProduct.name, newProduct.price, newProduct.category])];
                    case 1:
                        result = _a.sent();
