...
var dashboard = new dashboard_service_1["default"]();
var getAllOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.allOrdersWithProducts()];
            case 1:
                orders = _a.sent();
...
var getOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.singleOrderWithProducts(req.params.id)];
            case 1:
                order = _a.sent();
                if (!order)
                    throw new errors_1["default"].NotFoundError("Order with ID: ".concat(req.params.id, " doesn't exist"));
...
var getUserOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.getUserOrders(req.params.id, req.query.status)];
            case 1:
                orders = _a.sent();
                if (!orders)
                    throw new errors_1["default"].NotFoundError("User with ID: ".concat(req.params.id, " doesn't exist"));
                res.json({ orders: orders });
                return [2 /*return*/];
        }
    });
